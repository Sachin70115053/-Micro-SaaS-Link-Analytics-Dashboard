...
//         try {
//           await dispatch(getLinks({ page: 1, search }));
...
//       fetchData();
//     }, [dispatch, search, navigate, isAuthenticated]);
...
//         <h1 className="text-2xl font-bold text-purple-700 mb-4 md:mb-0">
//           My Links
//         </h1>
...
//           <Link
//             to="/create-link"
//             className="px-6 py-2 bg-purple-600 text-white rounded-md hover:bg-purple-700 transition-colors whitespace-nowrap text-center"
//           >
//             + Create New
//           </Link>
//         </div>
...
//   if (status === 'loading' && Array.isArray(links) && links.length === 0) {
//     return <Spinner />;
//   }
...
//         // If still not authenticated after loading user, redirect
...
//     initializeDashboard();
//   }, [dispatch, search, navigate, isAuthenticated, authLoading]);
