...
//         <h1 className="text-2xl font-bold text-purple-700">Link Analytics</h1>
//         <Link
//           to="/dashboard"
...
//           <div>
//             <h2 className="text-lg font-medium text-gray-900">Original URL</h2>
//             <p className="text-gray-600 break-all">{currentLink.longUrl}</p>
//           </div>
//           <div>
//             <h2 className="text-lg font-medium text-gray-900">Short URL</h2>
//             <a
//               href={`${import.meta.env.REACT_APP_BASE_URL}/${currentLink.shortCode}`}
//               target="_blank"
//               rel="noopener noreferrer"
//               className="text-purple-600 hover:text-purple-800"
//             >
//               {`${import.meta.env.REACT_APP_BASE_URL}/${currentLink.shortCode}`}
//             </a>
//           </div>
//           <div>
//             <h2 className="text-lg font-medium text-gray-900">Total Clicks</h2>
...
//       <div className="bg-white rounded-lg shadow p-6">
//         <h2 className="text-xl font-bold text-purple-700 mb-4">Clicks Over Time</h2>
//         <div className="h-80">
...
//         <div className="bg-white rounded-lg shadow p-6">
//           <h2 className="text-xl font-bold text-purple-700 mb-4">Devices</h2>
//           <div className="h-64">
//             <ResponsiveContainer width="100%" height="100%">
//               <PieChart>
//                 <Pie
...
//         <div className="bg-white rounded-lg shadow p-6">
//           <h2 className="text-xl font-bold text-purple-700 mb-4">Browsers</h2>
//           <div className="h-64">
//             <ResponsiveContainer width="100%" height="100%">
//               <BarChart
...
//         <div className="bg-white rounded-lg shadow p-6">
//           <h2 className="text-xl font-bold text-purple-700 mb-4">Locations</h2>
//           <div className="h-80">
//             <ResponsiveContainer width="100%" height="100%">
//               <BarChart
...
//             <ResponsiveContainer width="100%" height="100%">
//               <LineChart data={clicksByDay} margin={{ top: 5, right: 30, left: 20, bottom: 5 }}>
//                 <CartesianGrid strokeDasharray="3 3" />
//                 <XAxis 
//                   dataKey="_id" 
...
//                 <Tooltip />
//                 <Legend />
//                 <Line type="monotone" dataKey="count" stroke="#8884d8" activeDot={{ r: 8 }} name="Clicks" />
//               </LineChart>
//             </ResponsiveContainer>
//           ) : (
//             <p className="text-gray-500 text-center">No click data available for the past 30 days.</p>
//           )}
//         </div>
//       </div>
...
//               <ResponsiveContainer width="100%" height="100%">
//                 <BarChart data={clicksByBrowser} margin={{ top: 5, right: 30, left: 20, bottom: 5 }}>
//                   <CartesianGrid strokeDasharray="3 3" />
//                   <XAxis dataKey="_id" />
//                   <YAxis />
//                   <Tooltip />
...
//               </ResponsiveContainer>
//             ) : (
//               <p className="text-gray-500 text-center">No browser data available.</p>
//             )}
//           </div>
//         </div>
//       </div>
...
//           <div className="h-80">
//             <ResponsiveContainer width="100%" height="100%">
//               <BarChart data={clicksByCountry} layout="vertical" margin={{ top: 5, right: 30, left: 20, bottom: 5 }}>
//                 <CartesianGrid strokeDasharray="3 3" />
//                 <XAxis type="number" />
//                 <YAxis dataKey="_id" type="category" width={100} />
//                 <Tooltip />
